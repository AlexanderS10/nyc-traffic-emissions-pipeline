...
### Results
- H3 join elapsed_s: `0.350` (rows=`13433`)
- Geometry-style join elapsed_s: `2.476` (rows=`15135`)
- Relative speedup (geometry/h3): `7.07x`
